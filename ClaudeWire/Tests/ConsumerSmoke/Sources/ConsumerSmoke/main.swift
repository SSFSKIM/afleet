...
_ = (link, origin, launch.arguments(), initCfg.payload(), answer, type(of: spec).subtype, input.frame(uuid: UUID()), envelope, frame, process.events, handshake, systemInit, event, exit, ProcessStatus.launching)
