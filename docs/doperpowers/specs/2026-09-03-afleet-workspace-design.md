...
- **Status:** cut landed 2026-09-07 as `2026-09-07-c6-conversation-surface.md` (four leaves,
  ...
  remains a cross-owner prerequisite (shell/lifecycle implementation, C6 integration verification),
  also blocking item 47's entry and isolation-dependent permission legs. Closure requires every
