...
- **Status:** cut landed 2026-09-07 as `2026-09-07-c6-conversation-surface.md` (four leaves,
  two waves); all four merged by 2026-09-10; **recomposed** 2026-09-10 on `main` (two review
  lenses, two correctives, the lineage check); closes when the human-witness checklist's C6 legs
  are walked.
...
- 2026-09-10 C6 recomposition (composite Revision Note of the same date; `main` `91e0902`): the
  correctives named there landed on `main`; §17.9's C6 row and §17.4's C6 status recomposed. The
  human-witness checklist under `docs/doperpowers/checklists/` carries C6's remaining legs, and
  tracker 162 (no new-channel path, which item 47's *New channel* stands on) is the root's to own.
