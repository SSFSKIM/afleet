...
- **Status:** cut landed 2026-09-07 as `2026-09-07-c6-conversation-surface.md` (four leaves,
  ...
  435's unobserved-rebuild relay-conclusion gap remains open; 427 is deferred production item-builder
